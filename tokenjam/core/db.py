...
MIGRATIONS: list[tuple[int, str]] = [
    ...
    (24,
     ...
     + LEDGER_TABLES_SQL),
    # Migration 25: session-scoped span reconciliation index. The ingest-time
    ...
    (25, "CREATE INDEX IF NOT EXISTS idx_spans_session_id ON spans(session_id)"),
    # Migration 26: span attribution resolution step (Ownership 3-step ladder).
    ...
    (26, "ALTER TABLE spans ADD COLUMN IF NOT EXISTS attribution_step TEXT"),
]
...
EXPECTED_ADDITIVE_COLUMNS: list[tuple[str, str, str]] = [
    ...
    ("spans",    "attribution_step",        "TEXT"),               # migration 26
]
